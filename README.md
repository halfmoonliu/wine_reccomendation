...
Please see the pdf file for a quick walk through the project. If you would like to dig into details, please have a look at the Jupyter notebook in the branch. Check also __<ins>my blog post</ins>__(https://halfmoonliu.github.io/posts/wine-recommendation-using-the-aroma-wheel-link/) for more detailed description!
